...
trap 'rm -f warpendpoint ip.txt >/dev/null 2>&1' EXIT
...
# Display header
echo -e "${cyan}===========================================${rest}"
echo -e "${cyan}|          VlessIPOptimizer           |${rest}"
echo -e "${cyan}| GitHub: ${blue}https://github.com/Argh94${rest} |${rest}"
echo -e "${cyan}===========================================${rest}"

# Display creator information
display_creator_info() {
    echo -e "${purple}*************************************${rest}"
    echo -e "${purple}*          VlessIPOptimizer           *${rest}"
    echo -e "${purple}*************************************${rest}"
